...
public class HttpServerRoutesTransportProviderServlet implements McpServerTransportProvider {

	/** Logger for this class */
	private static final Logger logger = LoggerFactory.getLogger(HttpServerRoutesTransportProviderServlet.class);
	 ...
	 */
	public HttpServerRoutesTransportProviderServlet(
		...
		// TODO - routes to get and put, telemetry
	 ...
	 */
	@Override
	protected void doPost(HttpServerRequest request, HttpServerResponse response) {
	 ...
	 */
	private abstract class HttpServletMcpSessionTransport implements McpServerTransport {
		 ...
		 */
		HttpServletMcpSessionTransport(String sessionId, PrintWriter writer) {
